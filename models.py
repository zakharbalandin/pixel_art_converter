...
class Conversion(db.Model):
    ...
    def to_dict(self):
        return {
            ...
            'pixel_size': self.pixel_size, 'palette': self.palette,
            'result_filename': self.result_filename, 'result_size': self.result_size,
            'created_at': self.created_at.isoformat(),
            'processing_time_ms': self.processing_time_ms, 'status': self.status
        }
