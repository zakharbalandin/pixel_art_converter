...
def log_auth_event(event_type, username=None, user_id=None, ip_address=None, 
...
def log_conversion_event(original_file, pixel_size, palette, duration_ms,
                        user_id=None, success=True, error=None):
